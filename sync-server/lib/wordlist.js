// BIP39 English wordlist — 2048 words designed for unambiguous recall
...
const WORDS = [
  ...
  "expand","expect","expire","explain","expose","extend","extra","eye","eyebrow","fabric",
  ...
  "organ","orient","original","ornament","other","otter","ought","ounce","out","outdoor",
  ...
  "stairs","stamp","stand","start","state","stay","steak","steel","step","stereo",
  ...
  "sunset","super","supply","support","survive","suspect","sustain","swallow","swamp","swap",
...
// ── Generator ──────────────────────────────────────
// Generate n-word phrase. Default 5 words for ~2048^5 ≈ 3.6e16 combinations.
function generate(words = 5, separator = "-") {
  const picked = [];
...
// Validate that a phrase is composed of known words
function isValid(phrase, separator = "-") {
  const parts = phrase.split(separator);
  if (parts.length < 2) return false;
  const wordSet = new Set(WORDS);
  return parts.every(w => wordSet.has(w));
}

module.exports = { WORDS, generate, isValid };
